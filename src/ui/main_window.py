...
from src.ui.mixins.overlay_buttons import OverlayButtonsMixin
from src.ui.mixins.region2d import Region2dMixin
from src.ui.mixins.subplot_menus import SubplotMenusMixin
from src.ui.mixins.variable_list import VariableListMixin
from src.ui.mixins.layout import LayoutMixin
from src.ui.mixins.case_sliders import CaseSlidersMixin
from src.ui.mixins.time_controls import TimeControlsMixin
from src.ui.mixins.data_loading import DataLoadingMixin
...
class MainWindow(
    ...
    def _with_margin(self, ymin: float, ymax: float) -> Tuple[float, float]:
        from src.plotting import ylim as ylim_mod
